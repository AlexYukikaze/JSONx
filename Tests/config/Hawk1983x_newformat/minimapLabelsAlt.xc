 ...
 */
{
  "labels": {
      ...
      "units": {
        ...
        "format": {
          // Союзник.
		  "ally":  "<textformat leading='-2'><span class='mm_a'>    <font face='BloodyShacky' size='{{xvm-stat?7|0}}' color='{{c:xte|#FFFFFF}}'>&#61512;</font>\n{{vehicle}}</span></textformat>",
		  // Тимкиллер.
		  "teamkiller":  "<textformat leading='-2'><span class='mm_t'>    <font face='BloodyShacky' size='{{xvm-stat?7|0}}' color='{{c:xte|#FFFFFF}}'>&#61512;</font>\n{{vehicle}}</span></textformat>",
          // Враг.
		  "enemy": "<textformat leading='-2'><span class='mm_e'>    <font face='BloodyShacky' size='{{xvm-stat?7|0}}' color='{{c:xte|#FFFFFF}}'>&#61512;</font>\n{{vehicle}}</span></textformat>",
          // Взводный.
		  "squad": "<textformat leading='-2'><span class='mm_s'>     <font face='BloodyShacky' size='{{xvm-stat?7|0}}' color='{{c:xte|#FFFFFF}}'>&#61512;</font>\n<i>{{name%.10s}}</i></span></textformat>",
		 ...
		 "lost":  "<textformat leading='-3'><span class='mm_dot'>{{vehicle-class}}</span><font face='BloodyShacky' size='{{xvm-stat?8|0}}' color='{{c:xte|#FFFFFF}}'>&#61512;</font>\n<span class='mm_l'> {{vehicle}}</span></textformat>",
          // Out of radio range squadman
          // Взводный, с которым потеряна связь
          "lostsquad":  "<textformat leading='-3'><span class='mm_dot'>{{vehicle-class}}</span>\n<span class='mm_ls'> <i>{{name%.10s}}</i></span></textformat>",
           // Мертвый союзник.
          "deadally":  "<textformat leading='-3'><span class='mm_dot'>&#61524;</span>\n<span class='mm_da'></span></textformat>",
          // Мертвый тимкиллер.
          "deadteamkiller":  "<textformat leading='-3'><span class='mm_dot'>&#61524;</span>\n<span class='mm_dt'></span></textformat>",
          // Мертвый противник.
          "deadenemy": "<textformat leading='-3'><span class='mm_dot'>&#61524;</span>\n<span class='mm_de'></span></textformat>",
          // Мертвый взводный.
        ...
        "css": {
          ...
          "deadally":		".mm_da{font-family:$FieldFont; font-size:8px; color:#789963;} .mm_dot{font-family:BloodyShacky; font-size:8px; color:#006100;}",
          ...
          "deadenemy":		".mm_de{font-family:$FieldFont; font-size:8px; color:#AB736F;} .mm_dot{font-family:BloodyShacky; font-size:8px; color:#7D0701;}",
